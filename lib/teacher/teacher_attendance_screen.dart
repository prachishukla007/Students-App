...
class _TeachersAttendanceScreenState extends State<TeachersAttendanceScreen> {
  ...
  List<AttendanceItems> attendanceList = [
    AttendanceItems(
        image: "assets/images/abhinav.png",
        name: "Sahil Sharma",
    ...
    AttendanceItems(
        ...
        attendanceType: AttendanceType.present),
    AttendanceItems(
        image: "assets/images/jayneel.png",
        name: "Rahul",
        attendanceType: AttendanceType.present),
    AttendanceItems(
    ...
    AttendanceItems(
        ...
        attendanceType: AttendanceType.present),
    AttendanceItems(
        image: "assets/images/sourav.png",
        name: "Ajay",
        attendanceType: AttendanceType.present),
    AttendanceItems(
        image: "assets/images/udit.png",
        name: "Manish",
        attendanceType: AttendanceType.present),
    AttendanceItems(
        image: "assets/images/vinit.png",
        name: "Aradhya Diwakar",
        attendanceType: AttendanceType.present),
    AttendanceItems(
        image: "assets/images/abhinav.png",
        name: "Vinit Tanwar",
            ...
            children: [
              GestureDetector(
                onTap: () {
                  setState(() {
                    itemData = item;
                    item.attendanceType = AttendanceType.present;
                  });
                },
                child: Container(
                  padding:
                  ...
                  decoration: BoxDecoration(
                      ...
                      color: item.attendanceType == AttendanceType.present
              ...
              GestureDetector(
                onTap: () {
                  setState(() {
                    itemData = item;
                    item.attendanceType = AttendanceType.absent;
                  });
                },
                child: Container(
                  padding:
                  ...
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(5),
                      color: item.attendanceType == AttendanceType.absent
                          ? const Color(0xFF8C4AF2)
                          : Colors.grey.shade300),
                  child: Text(
                    "Absent",
